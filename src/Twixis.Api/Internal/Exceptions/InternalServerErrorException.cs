...
public sealed class InternalServerErrorException : HttpResponseException
{
    public InternalServerErrorException(string error, string message) : base(error, message, HttpStatusCode.InternalServerError)
    {
    }
}
