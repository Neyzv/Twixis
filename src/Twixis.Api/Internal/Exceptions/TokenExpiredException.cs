...
public sealed class TokenExpiredException : HttpResponseException
{
    public TokenExpiredException(string error, string message) : base(error, message, HttpStatusCode.Unauthorized)
    {
    }
}
