...
public sealed class BadScopeException : HttpResponseException
{
    public BadScopeException(string error, string message) : base(error, message, HttpStatusCode.Unauthorized)
    {
    }
}
