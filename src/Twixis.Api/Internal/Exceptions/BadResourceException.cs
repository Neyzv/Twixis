...
public sealed class BadResourceException : HttpResponseException
{
    public BadResourceException(string error, string message) : base(error, message, HttpStatusCode.NotFound)
    {
    }
}
