...
public sealed class BadGatewayException : HttpResponseException
{
    public BadGatewayException(string error, string message) : base(error, message, HttpStatusCode.BadGateway)
    {
    }
}
